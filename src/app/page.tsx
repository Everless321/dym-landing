...
export default function Home() {
  return (
    <div className="min-h-screen bg-white text-[#1d1d1f]">
      ...
      {/* Download Section */}
      <section id="download" className="py-20 px-6 bg-[#fbfbfd]">
        <div className="max-w-[980px] mx-auto text-center">
          <h2 className="text-4xl sm:text-5xl font-semibold text-[#1d1d1f] mb-4">立即下载</h2>
          <p className="text-xl text-[#86868b] mb-12">选择适合你系统的版本</p>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
            {/* macOS */}
            <div className="p-8 rounded-3xl bg-white shadow-sm hover:shadow-xl transition-all cursor-pointer group">
              <svg className="w-12 h-12 mx-auto mb-4 text-[#1d1d1f]" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
              </svg>
              <h3 className="font-semibold text-xl text-[#1d1d1f] mb-2">macOS</h3>
              <p className="text-sm text-[#86868b] mb-4">Intel & Apple Silicon</p>
              <a
                href="https://ghfast.top/https://github.com/Everless321/dYm/releases/download/v1.1.7/dym-1.1.7.dmg"
                className="inline-block w-full py-3 px-4 bg-[#0071e3] text-white rounded-xl font-medium hover:bg-[#0077ed] transition-colors"
              >
                下载 .dmg
              </a>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-white shadow-sm hover:shadow-xl transition-all cursor-pointer group">
              ...
              <h3 className="font-semibold text-xl text-[#1d1d1f] mb-2">Windows</h3>
              <p className="text-sm text-[#86868b] mb-4">Windows 10+</p>
              <a
            ...
            <div className="p-8 rounded-3xl bg-white shadow-sm hover:shadow-xl transition-all cursor-pointer group">
              ...
              <h3 className="font-semibold text-xl text-[#1d1d1f] mb-2">Linux</h3>
              <p className="text-sm text-[#86868b] mb-4">AppImage / deb</p>
              <a
          ...
          <p className="mt-2 text-sm text-[#86868b]">
            macOS 首次运行: <code className="bg-[#f5f5f7] px-2 py-1 rounded text-xs">sudo xattr -cr /Applications/dYm.app/</code>
          </p>
        </div>
      </section>
