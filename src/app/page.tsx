      ...
      <nav className="fixed top-0 left-0 right-0 z-50 nav-blur border-b border-black/5">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            ...
            <a href="https://github.com/Everless321/dYm/releases/latest" target="_blank" rel="noopener noreferrer" className="text-sm text-[#0c0a09]/70 hover:text-[#0c0a09] transition-colors cursor-pointer">
              下载
            </a>
            <a
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <div className="animate-fade-in-up animation-delay-400 flex flex-col sm:flex-row gap-4 justify-center mb-16">
            ...
            <div className="relative group">
              ...
              {/* Hover Dropdown */}
              <div className="download-dropdown absolute top-full left-1/2 -translate-x-1/2 pt-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-black/5 p-2 min-w-[280px]">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="font-medium text-[#0c0a09]">macOS</div>
                      <div className="text-xs text-[#0c0a09]/50">Intel & Apple Silicon · .dmg</div>
                    </div>
                    <svg className="w-4 h-4 text-[#0c0a09]/30" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="font-medium text-[#0c0a09]">Windows</div>
                      <div className="text-xs text-[#0c0a09]/50">Windows 10+ · .exe</div>
                    </div>
                    <svg className="w-4 h-4 text-[#0c0a09]/30" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                    </svg>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="font-medium text-[#0c0a09]">Linux</div>
                      <div className="text-xs text-[#0c0a09]/50">AppImage</div>
                    </div>
                    <svg className="w-4 h-4 text-[#0c0a09]/30" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                    </svg>
